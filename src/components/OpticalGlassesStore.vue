<template>
  <div>
    ...
    <div class="d-flex justify-between">
      <picture>
        <source
          srcset="../assets/images/product-header-sm-1.png"
          media="(max-width: 768px)"
        />
        <img src="../assets/images/product-header-1.png" alt="glasses-image" />
      </picture>
      <picture>
        <source
          srcset="../assets/images/product-header-sm-2.png"
          media="(max-width: 768px)"
        />
        <img src="../assets/images/product-header-2.png" alt="glasses-image" />
      </picture>
    </div>

    <div class="optical">
      <div class="container">
        <h2 class="optical-title">Celluloid Combi</h2>
        <h2 class="optical-subtitle">賽璐珞鈦金屬混合鏡框</h2>
        <div class="row">
          <div class="column">
            <div class="card">
              <img src="../assets/images/product-1.png" alt="" />
              <div class="d-flex justify-between">
                <p class="optical-item">BJ41600S</p>
                <p class="optical-item-price">NTD3,490</p>
              </div>
              <div class="d-flex">
                <div
                  class="mr-2"
                  style="width: 24px; height: 24px; background-color: #5f3e2d"
                ></div>
                <div
                  style="width: 24px; height: 24px; background-color: #b75929"
                ></div>
              </div>
            </div>
          </div>
